...
import com.example.vinter.Activity.DetailActivity;
import com.example.vinter.Domain.ItemsDomain;
import com.example.vinter.databinding.ViewholderPopListBinding;
...
public class PopularAdaptor  extends RecyclerView.Adapter<PopularAdaptor.Viewholder>{
    ...
    public PopularAdaptor(ArrayList<ItemsDomain> items) {
        this.items = items;
    }

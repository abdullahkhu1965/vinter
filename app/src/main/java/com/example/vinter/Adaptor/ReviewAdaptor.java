...
import com.example.vinter.Domain.ReviewDomain;
import com.example.vinter.databinding.ViewholderReviewBinding;
...
public class ReviewAdaptor extends RecyclerView.Adapter<ReviewAdaptor.Viewholder> {
    ...
    public ReviewAdaptor(ArrayList<ReviewDomain> items) {
        this.items = items;
    }

    @NonNull
    @Override
    public ReviewAdaptor.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ReviewAdaptor.Viewholder holder, int position) {
